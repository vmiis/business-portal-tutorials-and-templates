...
_set_req_export=function(){
    ...
    sql+=" select ID,ParticipantUID,Site,Information,ParticipantUID,Participant=sql_participant,DateTime,Author from participant left join task on PUID=ParticipantUID";
    _set_from_to();
